...
describe "#new" do
    it "must take 1 parameter and returns a role object" do
    	 get "new"
        @roles=Role.new(:name=>'admin')
       @roles.should be_an_instance_of Role
    end
end

describe "#show" do
	it "must take role id and render show page of role" do 

    @roles=Role.create!(:name=>'admin')
		get "show",:id=>@roles.id
		response.should render_template(:action => 'show')

end
end
describe "#index" do 
	it "it takes nothing as input and render all roles" do
		get "index"
